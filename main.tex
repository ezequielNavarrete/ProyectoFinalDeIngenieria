...
\newpagestyle{ruled}{
	\sethead{\includegraphics[width=3.7cm]{./images/UADE_LARGE}}
			{\parbox[b]{0.43\textwidth}{\raggedright\MakeUppercase{Análisis con IA para detectar patrones de riesgo en fútbol}}}
			{
				\raisebox{1.5ex}{%
...
% Para diagramas de Gantt y páginas apaisadas
\usepackage{pgfgantt}
...
\input{chapters/03_estado_del_arte}
